...
tickers = ['AAPL', 'MSFT', 'GOOGL', 'AMZN', 'JNJ', 'PFE', 'XOM', 'CVX', 'KO', 'PEP', 'WMT', 'DIS', 'GM', 'IBM', 'BA', 'INTC', 'MCD', 'T', 'VZ', 'WFC', 'JPM', 'GE', 'CSCO', 'NVDA', 'C', 'BNS', 'CAT', 'NKE', 'TGT']
...
#Save the model
model.save('../Models/multi_industry_full_technical.keras')